...
SHOP_ITEMS = [
    ...
    },
    {
        'slug': 'glasses',
        'name': 'Óculos',
        'description': 'Cosmético de rosto para o seu avatar.',
        'price': 90,
        'item_type': 'Cosmético',
        'bonus_value': Decimal('0.00'),
        'icon': '👓',
        'cosmetic_slot': 'face',
        'layer_file': 'glasses.png',
    },
    {
        'slug': 'hoodie',
        'name': 'Moletom',
        'description': 'Cosmético de corpo para o seu avatar.',
        'price': 100,
        'item_type': 'Cosmético',
        'bonus_value': Decimal('0.00'),
        'icon': '👕',
        'cosmetic_slot': 'body',
        'layer_file': 'hoodie.png',
    },
    {
        'slug': 'brazil_shirt',
        'name': 'Camisa do Brasil',
        'description': 'Vista as cores do Brasil no seu avatar.',
        'price': 110,
        'item_type': 'Cosmético',
        'bonus_value': Decimal('0.00'),
        'icon': '🇧🇷',
        'cosmetic_slot': 'body',
        'layer_file': 'brazil_shirt.png',
    },
]

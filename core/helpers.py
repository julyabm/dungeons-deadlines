...
class AvatarBuildOptions():
    ...
    def __init__(self, **kwargs):
        ...
        self.hairVariant = self.__validate_hair_variant(kwargs.get('hairVariant', HairOptions.SHORT21.value))
        ...
        self.hairColor = self.__validate_color(kwargs.get('hairColor', ColorOptions.BROWN.value))
        self.clothesColor = self.__validate_color(kwargs.get('clothesColor', ColorOptions.BLUE.value))
